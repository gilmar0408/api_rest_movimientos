...
public class CustomerRequest {
	...
	public String toString() {
		return "CustomerRequest [full_name=" + full_name + ", gender=" + gender + ", age=" + age + ", identification="
				+ identification + ", address=" + address + ", phone=" + phone + ", secret_password=" + secret_password
